...
void UISideView::on_init() {
	...
	btnSave.set_text(LR"(
		<svg width="256" height="256" viewBox="0 0 256 256" fill="gray">
			<path d="M216 91.314V208a8 8 0 0 1-8 8l-32 .008v-64a8 8 0 0 0-8-8H88a8 8 0 0 0-8 8v64L48 216a8 8 0 0 1-8-8V48a8 8 0 0 1 8-8h116.686a8 8 0 0 1 5.657 2.343l43.314 43.314A8 8 0 0 1 216 91.314Z" fill="lightgray"/>
	...
	btnClose.set_text(LR"(
		<svg viewBox="0 0 252 252" fill="gray">
	...
	btnAdj.set_text(LR"(
		<svg width="32" height="32" viewBox="0 0 32 32">
			<path fill="gray" d="M8 9.142V4H6v5.142c-1.72.447-3 2-3 3.858s1.28 3.411 3 3.858v10.096h2V16.858c1.72-.447 3-2 3-3.858S9.72 9.589 8 9.142zM7 15a2 2 0 1 1-.001-3.999A2 2 0 0 1 7 15zm10 1.142V4h-2v12.142c-1.72.447-3 2-3 3.858s1.28 3.411 3 3.858v3.096h2v-3.096c1.72-.447 3-2 3-3.858s-1.28-3.411-3-3.858zM16 22a2 2 0 1 1-.001-3.999A2 2 0 0 1 16 22zm13-6c0-1.858-1.28-3.411-3-3.858V4h-2v8.142c-1.72.447-3 2-3 3.858s1.28 3.411 3 3.858v7.096h2v-7.096c1.72-.447 3-2 3-3.858zm-4 2a2 2 0 1 1-.001-3.999A2 2 0 0 1 25 18z"/>
		</svg>
	)");
	btnFilter.set_text(LR"(
		<svg viewBox="0 0 32 32" stroke="gray" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"  > 
	...
	btnUndo.set_text(LR"(
		<svg viewBox="-2 -2 36 36" stroke="gray" fill="none" stroke-width="2" stroke-miterlimit="10">
	...
	btnHistory.set_text(LR"(
		<svg width="18" height="18" viewBox="0 0 18 18" fill="gray">
	...
	btnZoom.set_text(LR"(
		<svg viewBox="0 0 310.42 310.42" transform="scale(-1,1) " fill="gray">
	...
	btnInfo.set_text(LR"(
		<svg x="0px" y="0px" viewBox="0 0 32 32" fill="gray">
	...
	btnOpen.set_menu(new UIMOpen());
	btnSave.set_menu(new UIMSave());
	btnAdj.set_menu(new UIMAdjust());
	btnFilter.set_menu(new UIMFilter());
	btnHistory.set_menu(new UIMHistory());
	btnZoom.set_menu(new UIMZoom());
}
